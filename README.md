...
**Users should notice that before using the pipeline, users should prepare the database and usearch and put them under the directoty DB and bin, respectively**
