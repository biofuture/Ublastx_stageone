...
1. obtain [CARD](https://card.mcmaster.ca/download/0/broadsteet-v1.0.1.tar.gz) and [ARDB](http://ardb.cbcb.umd.edu/) as well as [usearch](http://www.drive5.com/usearch/).  
