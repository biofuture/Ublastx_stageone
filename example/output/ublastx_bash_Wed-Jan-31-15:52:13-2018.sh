...
/sharedisk3/XT-Workhome/JXT/GitProject/ARGs-OAP-V2.0-DIST/bin/diamond blastx -q inputfqs/STAS_1.fa -d /sharedisk3/XT-Workhome/JXT/GitProject/ARGs-OAP-V2.0-DIST/DB/KO30_DIAMOND.dmnd -o output/STAS.uscmg_1.dmd -f tab  -p 10 -e 3  --id 0.45 --max-target-seqs 1
/sharedisk3/XT-Workhome/JXT/GitProject/ARGs-OAP-V2.0-DIST/bin/diamond blastx -q inputfqs/STAS_2.fa -d /sharedisk3/XT-Workhome/JXT/GitProject/ARGs-OAP-V2.0-DIST/DB/KO30_DIAMOND.dmnd -o output/STAS.uscmg_2.dmd -f tab  -p 10  -e 3 --id 0.45 --max-target-seqs 1
...
#Using Diamond to search USCMGs
/sharedisk3/XT-Workhome/JXT/GitProject/ARGs-OAP-V2.0-DIST/bin/diamond blastx -q inputfqs/SWHAS104_1.fa -d /sharedisk3/XT-Workhome/JXT/GitProject/ARGs-OAP-V2.0-DIST/DB/KO30_DIAMOND.dmnd -o output/SWHAS104.uscmg_1.dmd -f tab  -p 10 -e 3  --id 0.45 --max-target-seqs 1
/sharedisk3/XT-Workhome/JXT/GitProject/ARGs-OAP-V2.0-DIST/bin/diamond blastx -q inputfqs/SWHAS104_2.fa -d /sharedisk3/XT-Workhome/JXT/GitProject/ARGs-OAP-V2.0-DIST/DB/KO30_DIAMOND.dmnd -o output/SWHAS104.uscmg_2.dmd -f tab  -p 10  -e 3 --id 0.45 --max-target-seqs 1
cat output/SWHAS104.uscmg_1.dmd output/SWHAS104.uscmg_2.dmd > output/SWHAS104.uscmg.blastx.txt
#The script file is output/ublastx_bash_Wed-Jan-31-15:52:13-2018.sh
